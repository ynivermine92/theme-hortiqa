...
function filter_blogs_callback()
{
    ...
    $main_cat = get_category_by_slug('Главная');   /* сохранием рубрику котрую будем игнорировать блоге */
    ...
    $query = new WP_Query([
        ...
        'category__not_in' => [$main_cat->term_id],  /* игнорирум вывод рубрику Главная */
    ]);
